...
| cell_qw    | Коммутация       | Выключатель                          |
| cell_qr    | Коммутация       | Отделитель                           |
| cell_qk    | Коммутация       | Короткозамыкатель                    |
...
- **Анимации**:
  ...
  - Intrinsic-блоки для cell_alr / cell_qw (обёртки над required-слотом)
