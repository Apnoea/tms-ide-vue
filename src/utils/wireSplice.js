// Геометрия/топология редактирования провода символом — две инверсные операции:
 ...
 * касательная, а не линия центров ячеек: rightAngle-роутер гнёт провод). Сторона
 * курсора выбирает между двумя вариантами выравнивания (отличаются на 180°):
