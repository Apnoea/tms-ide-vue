...
/**
 * Допуск хит-теста по вертикали (в дополнение к полутолщине тела): тело шины 8px,
 * курсором в него не попасть. Больше — и символ прилипал бы к шине, когда его рядом
 * просто поставили.
 */
