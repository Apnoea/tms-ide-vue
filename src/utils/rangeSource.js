...
import { BUS_STENCIL_ID, RANGE_SLOT } from '../constants/ids'
...
/** Провод — прозрачное звено цепи: диапазоны наследует. */
...
/**
 * Унаследованный источник провода: обход в ширину от концов до первого
...
/**
 * Действующий источник элемента: своя настройка с тегом, иначе у провода —
