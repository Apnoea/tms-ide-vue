 ...
 * (viewBox 0 0 W H), `buildStencilJson` — stencil.json. Чистые функции: координаты
 * приходят уже в системе символа и снапнутыми, здесь только рендер.
 *
 * Примитивы: rect, line, circle, polyline, text. Фигуры со состоянием группируются в
 * `<g data-anim-suffix=".<ключ>">`, оттуда же строится animationTemplate. Подпись
 * участвует в видимости по состоянию, но не в перекраске — CSS исключает `<text>`.
 */
