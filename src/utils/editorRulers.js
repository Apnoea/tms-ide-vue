...
// Шаг сетки холста редактора = 1px (= снап вершин фигур). Только дефолт для range*;
// снап фигур задаёт useStencilEditor.SHAPE_GRID.
const GRID_STEP = 1
...
/**
 * Цвет линии сетки: три уровня яркости — еле видная на каждый 1px, заметнее на
 * кратных 5, тёмная на кратных 10 (на десятки садятся порты).
 */
