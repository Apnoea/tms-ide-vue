/**
 * Whitelist тегов и атрибутов для чужого `shape.svg`: он приходит из .zip, уходит
 * в v-html и appendChild, а оверрайды в IDB переживают reload. Чистим на входе в
 * реестр — дальше по конвейеру svgText безопасен. Whitelist, а не blacklist:
 * список нужного нам закрыт, список опасного — нет.
 */
