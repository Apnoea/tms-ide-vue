...
/**
 * Блок «Булево значение». Два источника:
 *  • `slotInfo` — булев слот стенсила (свой тег элемента, первой строкой без ×);
 *  • `groups` — зависимости-теги группами: внутри группы И, между группами ИЛИ.
 *    Не выполнена ни одна группа — элемент тускнеет (animation-off).
 *
