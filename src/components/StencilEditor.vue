<script setup>
/**
 * Редактор стенсилов — оверлей поверх холста: рисование примитивов, порты, стиль
 * фигур и анимация состояния, всё со снапом к сетке (вершины 1px, порты и размер
 * символа — PORT_GRID). Рисовать можно только в области стенсила (вокруг — та же
 * канва на .3).
 *
 ...
 * Vue). Открывается на создание или правку незалоченного стенсила
