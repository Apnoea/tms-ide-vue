...
const sections = [
  ...
  },
  {
    ...
    items: [
      { keys: ['ЛКМ', 'по ячейке/линии'], desc: 'Выделить (Inspector справа)' },
      ...
      { keys: ['ЛКМ', 'на порту → drag'], desc: 'Нарисовать линию между ячейками' },
  ...
  },
  {
    ...
    items: [
      ...
      { keys: ['Esc'], desc: 'Снять выделение / закрыть диалог' },
    ],
  },
]
</script>
