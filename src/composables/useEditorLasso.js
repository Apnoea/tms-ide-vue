...
/**
 * Лассо фигур в редакторе символов. Жесты как на холсте (useLasso), но модель
 * своя — примитивы в user-координатах, а не JointJS-граф.
 *
 * Рамка живёт в user-координатах и рисуется внутри SVG: не нужно пересчитывать
 * её на зуме и скролле stage. Захват по ПЕРЕСЕЧЕНИЮ bbox — иначе длинную линию
 * не поймать, не обведя целиком. Порты не берём, у них свой режим.
 *
 * @param {object} deps
