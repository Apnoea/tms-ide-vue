...
export function useCanvas() {
  return {
     ...
     * (символы, провода, подложка) свои полосы, команда двигает только свой слой и
     * перенумеровывает его целиком (utils/zOrder).
     *
     * РАЗМЕТКА — исключение: фигура уходит в подложку теми же четырьмя командами по
     * краям слоя («на задний план» — сразу, «ниже» — когда она уже на дне символов).
     *
