 ...
 * пиксельная точность), а порты и размер самого символа — к PORT_GRID (5,
...
// (boolSource/диапазоны), в символе не объявляем.
...
export function createStencilEditor() {
  // noRotate/noFlip/quality — декл-флаги символа, моделируем как поля (уезжают в json).
  ...
  // id редактируемого символа (null = создание нового). В режиме правки id
