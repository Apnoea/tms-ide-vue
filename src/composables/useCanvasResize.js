 ...
 * вектор жеста поворачивается на −angle, а ручки ставятся на визуальные углы
 * (`rotatePoint`). Позиция считается от ВИЗУАЛЬНОГО якоря — центр при смене размера
 * уезжает, и без компенсации символ уползёт из-под курсора. Повёрнутая ФИГУРА ручек не
